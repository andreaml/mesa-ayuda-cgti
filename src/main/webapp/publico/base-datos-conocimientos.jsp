            ...
            <div class="row col-12 d-flex justify-content-center align-items-center my-4 ml-0">
                <form class="form-group col-11 col-md-6 mx-md-5 px-0 mb-lg-0 mb-2">
                    <div class="input-group">
                        <input class="form-control " type="search" placeholder="Buscar" aria-label="Search" name="datoABuscar">
                        <span class="input-group-btn">
                            <button id="btnConsultar" class="btn btn-info " type="submit">Buscar</button>
                        </span>
                    </div> 
                </form>
            </div>
        ...
        <div id="divDescripcionTicket"class="container-fluid d-flex flex-column mt-5 col-12 col-md-11 col-lg-10 "style='display: none !important'>
            <div class="row mt-5">
                <div class="col-12 col-md-8">
                    ...
                    <p>Por: <output id="correoUsuarioTicket"/> el <output id="fechaRegistroTicket"/> a las <output id="horaRegistroTicket"/> hrs 
                        <div id="contenedorEstrellas"class="col-6 px-0">
                   ...
                   $.ajax({
                        ...
                        success: function(data, textStatus, jqXHR){
                            if (data===null){
                                ...
                                mostrarEstrellas(data.estadoSatisfaccion);
                            }
                        }
                    });
                });
                
                function mostrarEstrellas(estadoSatisfaccion){
                    for(let i=1; i<estadoSatisfaccion;i++){
                        $( "#contenedorEstrellas" ).append( "<i class="text-warning fa fa-star" aria-hidden="true"></i>" );
                    }
                    for(let j=estadoSatisfaccion; j<6;j++){
                        $( "#contenedorEstrellas" ).append( "<i class="text-muted fa fa-star" aria-hidden="true"></i>" );
                    }
                }
