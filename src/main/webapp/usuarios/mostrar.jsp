  ...
  <section class="container mt-5">
      <h3 class="text-center p-1">Usuarios tipo usuario</h3>
        <div class="row col-12 d-flex justify-content-center align-items-center my-4 ml-0">
            ...
            <button type="button" class="btn btn-info col-md-3 col-11" data-toggle="modal" data-target="#modal-agregarUsuario"><i class="fa fa-user-plus"></i> Agregar servicio</button>
        </div>
    </section>
    <!-- Fin de seccion 1 -->
      ...
      <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Dependencia 2</td>
                <td class="text-center d-flex flex-column flex-lg-row justify-content-around">
                    <button type="button " class="btn btn-info" data-toggle="modal" data-target="#modal-editarUsuario"><i class="fa fa-pencil"></i></button>
                    <button type="button " class="btn btn-danger" data-toggle="modal" data-target="#modal-eliminarUsuario"><i class="fa fa-trash-o"></i></button>
                </td>
            </tr>
            <tr>
                <td>usuario@ucol.mx</td>
...
<!--Inicio de modal agregar usurio tipo usuario -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-5">
                    ¿Realmente desea eliminar usuario usuario@ucol.mx ?   
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
